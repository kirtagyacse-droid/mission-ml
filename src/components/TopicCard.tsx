    ...
    <>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          {topic.title.toLowerCase().includes("deep learning") && (
            <a
              href="https://course.fast.ai/"
              target="_blank"
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold bg-[#180a2b] border border-[--color-accent-chartreuse]/40 text-[--color-accent-chartreuse] hover:text-white hover:border-[--color-accent-pink]/50 transition-all shadow-sm shrink-0"
            >
              <span>fast.ai Course ↗</span>
            </a>
          )}
        </div>
                ...
                {topic.title.toLowerCase().includes("deep learning") && (
                  <div className="pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-[#180a2b] border border-[--color-accent-chartreuse]/40 text-[--color-accent-chartreuse] hover:text-white hover:border-[--color-accent-pink]/60 transition-all shadow-md"
                    >
                      <span>🚀 Open Official Practical Deep Learning Course (fast.ai) ↗</span>
                    </a>
                  </div>
                )}
              </div>
