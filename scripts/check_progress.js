...
async function main() {
  ...
  console.log("Database URL:", url ? url.substring(0, 30) + '...' : 'undefined');
  ...
  console.log("All Progress records count:", allProgress.length);
  console.log("Progress records:", JSON.stringify(allProgress, null, 2));
